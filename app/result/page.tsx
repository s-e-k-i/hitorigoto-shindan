            ...
            <div className="rounded-2xl p-6" style={{ background: "linear-gradient(135deg, #ede9fe 0%, #dbeafe 100%)" }}>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <a
                  ...
                  className="flex items-center justify-center gap-2 bg-black hover:bg-gray-800 text-white text-sm font-bold rounded-xl transition-colors px-4 py-3"
                >
                  <svg viewBox="0 0 24 24" fill="white" width="20" height="20"><path d="M12.186 24h-.007c-3.581-.024-6.334-1.205-8.184-3.509C2.35 18.44 1.5 15.586 1.472 12.01v-.017c.03-3.579.879-6.43 2.525-8.482C5.845 1.205 8.6.024 12.18 0h.014c2.746.02 5.043.725 6.826 2.098 1.677 1.29 2.858 3.13 3.509 5.467l-2.04.569c-1.104-3.96-3.898-5.984-8.304-6.015-2.91.022-5.11.936-6.54 2.717C4.307 6.504 3.616 8.914 3.589 12c.027 3.086.718 5.496 2.057 7.164 1.43 1.783 3.631 2.698 6.54 2.717 2.623-.02 4.358-.631 5.8-2.045 1.647-1.613 1.618-3.593 1.09-4.798-.31-.71-.873-1.3-1.634-1.75-.192 1.352-.622 2.446-1.284 3.272-.886 1.102-2.14 1.704-3.73 1.79-1.202.065-2.361-.218-3.259-.801-1.063-.689-1.685-1.74-1.752-2.964-.065-1.19.408-2.285 1.33-3.082.88-.76 2.119-1.207 3.583-1.291a13.853 13.853 0 0 1 3.02.142c-.126-.742-.375-1.332-.75-1.757-.513-.586-1.308-.883-2.397-.893h-.056c-.82 0-1.943.228-2.655 1.43l-1.809-1.143c.977-1.647 2.64-2.459 4.644-2.459h.07c3.994.031 6.092 2.582 6.092 7.378 0 .465-.043.928-.13 1.389-.19 1.022-.552 1.954-1.085 2.766a6.524 6.524 0 0 1-2.01 1.998c-1.056.66-2.307 1.018-3.73 1.06-.067.002-.133.004-.2.004zm.024-9.923c-.089 0-.178.002-.268.006-1.917.106-3.035.94-2.974 2.228.06 1.258 1.16 1.895 2.846 1.804 1.135-.062 1.96-.455 2.517-1.17.556-.716.838-1.766.838-3.122a12.085 12.085 0 0 0-2.96.254z"/></svg>
                  Threadsでシェア
                </a>
                {/* URLコピー */}
                <button
