            ...
            <div className="rounded-2xl p-6" style={{ background: "linear-gradient(135deg, #ede9fe 0%, #dbeafe 100%)" }}>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <a
                  ...
                  className="flex items-center justify-center gap-2 bg-black hover:bg-gray-800 text-white text-sm font-bold rounded-xl transition-colors px-4 py-3"
                >
                  <svg viewBox="0 0 192 192" fill="white" width="20" height="20"><path d="M141.537 88.988a66.667 66.667 0 0 0-2.518-1.143c-1.482-27.307-16.403-42.94-41.457-43.1h-.34c-14.986 0-27.449 6.396-35.12 18.05l13.24 9.1c5.736-8.696 14.764-10.56 21.88-10.56h.23c8.452.054 14.828 2.512 18.96 7.304 3.012 3.51 5.023 8.347 5.993 14.428a100.405 100.405 0 0 0-24.233-1.032c-24.47 1.423-40.233 15.842-39.33 35.877.455 10.138 5.704 18.877 14.768 24.67 7.737 4.992 17.697 7.434 28.063 6.868 13.675-.76 24.414-5.966 31.916-15.471 5.679-7.285 9.274-16.728 10.88-28.64 6.52 3.934 11.348 9.117 14.015 15.4 4.495 10.537 4.766 27.834-9.33 41.895-12.406 12.375-27.32 17.733-49.853 17.9-24.963-.185-43.864-8.195-56.18-23.82-11.498-14.568-17.427-35.63-17.617-62.588.19-26.96 6.12-48.022 17.617-62.588 12.316-15.627 31.217-23.637 56.18-23.82 25.126.185 44.339 8.235 57.1 23.93 6.31 7.702 11.08 17.449 14.2 28.796l15.5-4.12c-3.72-13.796-9.647-25.663-17.757-35.348C154.95 18.105 131.483 8.21 101.936 8h-.414C71.918 8.21 48.718 18.157 35.08 35.89 22.75 52.116 16.397 75.68 16.185 96.024v.04c.212 20.343 6.565 43.908 18.895 60.132C48.718 173.929 71.918 183.877 101.52 184.086h.414c26.886-.184 45.748-7.263 61.339-22.815 20.727-20.666 20.07-46.635 13.26-62.518-4.931-11.563-14.37-20.975-34.996-26.765z"/></svg>
                  Threadsでシェア
                </a>
                {/* URLコピー */}
                <button
